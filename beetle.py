...
class Beetle(GameObject):
    ...
    def __init__(self, x, y, speed):
        ...
        self.down2 = pygame.transform.scale(self.down2, (40, 40))

        self.up1 = utils.load_image("assets", "BeetleUp1.png")
        self.up1 = pygame.transform.scale(self.up1, (40, 40))
        self.up2 = utils.load_image("assets", "BeetleUp2.png")
        self.up2 = pygame.transform.scale(self.up2, (40, 40))

        self.left1 = utils.load_image("assets", "BeetleLeft1.png")
        self.left1 = pygame.transform.scale(self.left1, (40, 40))
        self.left2 = utils.load_image("assets", "BeetleLeft2.png")
        self.left2 = pygame.transform.scale(self.left2, (40, 40))

        self.right1 = utils.load_image("assets", "BeetleRight1.png")
        self.right1 = pygame.transform.scale(self.right1, (40, 40))
        self.right2 = utils.load_image("assets", "BeetleRight2.png")
        self.right2 = pygame.transform.scale(self.right2, (40, 40))
